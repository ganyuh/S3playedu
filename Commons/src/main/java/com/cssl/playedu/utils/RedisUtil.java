...
//    }
     ...
     * @param key      键
     * @param value    值
     * @param duration 时间 如果time小于等于0 将设置无限期
     * @param unit     时间单位
     * @return true成功 false 失败
     */
    public boolean set(String key, Object value, long duration, TimeUnit unit) {
        return set(key, value, unit.toSeconds(duration));
    }
